	...
	return (
		<div className='footer-class'>
			<div className='footercontent'>
				<div className='footercontainercontent1'>
					<img
						...
						alt='Coinbase logo'
						loading='lazy'
						class='footercontainercontent1-img'
					></img>
					<select aria-label='Language selector' class='footerlang'>
					...
					<div class='footersec'>
						<div className='footersec-one'>© 2021 Coinbase</div>
